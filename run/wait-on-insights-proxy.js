...
const config = {
  ...
  // When devoloping locally, we define  qa.foo.redhat.com and friends in /etc/hosts.
  // But it's possible — and necessary in CI — to run selenium-test with that defined
  // only in the browser container.
  //
  // So, need to request https://qa.foo.redhat.com:1337/ without being able to resolve it!
