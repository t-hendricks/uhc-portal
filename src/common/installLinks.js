...
const links = {
  ...
  INSTALL_AZUREIPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_AZUREIPI_CLI_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_AZUREIPI_GETTING_STARTED: `${DOCS_BASE}/installing/installing_azure/installing-azure-account.html`,
  INSTALL_AZUREUPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST_44_PRE,
  INSTALL_AZUREUPI_CLI_LATEST: MIRROR_CLIENTS_LATEST_44_PRE,
  ...
  INSTALL_GCPIPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_GCPIPI_CLI_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_GCPIPI_GETTING_STARTED: `${DOCS_BASE}/installing/installing_gcp/installing-gcp-account.html`,
  INSTALL_GCPUPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_GCPUPI_CLI_LATEST: MIRROR_CLIENTS_LATEST,
  ...
  INSTALL_OSPIPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_OSPIPI_CLI_LATEST: MIRROR_CLIENTS_LATEST,
  INSTALL_OSPIPI_GETTING_STARTED: `${DOCS_BASE}/installing/installing_openstack/installing-openstack-installer-custom.html`,
  INSTALL_OSPUPI_INSTALLER_LATEST: MIRROR_CLIENTS_LATEST_44_PRE,
  INSTALL_OSPUPI_CLI_LATEST: MIRROR_CLIENTS_LATEST_44_PRE,
