...
import { Alert, GridItem, TextContent, Text, Title, TextVariants } from '@patternfly/react-core';

import links from '~/common/installLinks.mjs';
import ExternalLink from '~/components/common/ExternalLink';
import { Prerequisites } from '../../../common/Prerequisites';
import { AwsAccountDetailsSection } from './AwsAccountDetailsSection';
