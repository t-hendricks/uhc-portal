...
const SERVICE_MESH_DRAWER_PANEL_CONTENT = {
  head: (
    <Grid hasGutter>
      <GridItem span={2}>
        <img
        ...
        <TextContent>
          <TextList isPlain>
            ...
            <TextListItem>
              ...
              network using Red Hat OpenShift Service Mesh’s tools, including automated identity and
              certificate management, end-to-end mTLS encryption, and fine-grain application
            ...
            <TextListItem>
              <b>Enable traffic management capabilities:</b> Red Hat OpenShift Service Mesh provides
              a control plane and infrastructure that transparently enables traffic management
...
export default SERVICE_MESH_DRAWER_PANEL_CONTENT;
