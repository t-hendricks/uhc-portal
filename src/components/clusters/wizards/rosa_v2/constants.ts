...
export const testInitialValuesNetworkScreen: FormikValues = {
  hypershift: 'false',
  ...
  custom_operator_roles_prefix: 're-test-liqq',
  machine_type: 'm5.xlarge',
};

// Useful for testing wizard steps
export const testInitialValuesVpcScreen: FormikValues = {
  hypershift: 'false',
  install_to_vpc: true,
  shared_vpc: {
    is_allowed: true,
  ...
  product: 'ROSA',
  byoc: 'true',
  associated_aws_id: '000000000001',
  installer_role_arn: 'arn:aws:iam::000000000001:role/ManagedOpenShift-Installer-Role',
  support_role_arn: 'arn:aws:iam::000000000001:role/ManagedOpenShift-Support-Role',
  worker_role_arn: 'arn:aws:iam::000000000001:role/ManagedOpenShift-Worker-Role',
  control_plane_role_arn: 'arn:aws:iam::000000000001:role/ManagedOpenShift-ControlPlane-Role',
  rosa_max_os_version: '4.14',
  node_drain_grace_period: 60,
  upgrade_policy: 'manual',
  automatic_upgrade_schedule: '0 0 * * 0',
  ...
  custom_operator_roles_prefix: 'mycluster-u3cq',
  machine_type: 'm5.xlarge',
};
