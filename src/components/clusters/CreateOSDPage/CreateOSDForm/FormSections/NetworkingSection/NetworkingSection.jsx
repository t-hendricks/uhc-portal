...
function NetworkingSection({
  ...
  return (
    <>
      ...
      <FormGroup label="Network configuration" isRequired fieldId="network_configuration_toggle">
        <Field
              ...
              label: (
                <>
                  ...
                  <div className="pf-c-radio__description">
                    Creates a new VPC for your cluster using default values.
                  </div>
                </>
              ),
            },
            {
              ...
              label: (
                <>
                  Advanced
                  <div className="pf-c-radio__description">
                    Choose this option if you will ever need direct, private network connectivity to
                    your cluster, e.g. VPN or VPC peering.
                  </div>
                </>
              ),
            },
        ...
        <>
            ...
            >
              ...
              {cloudProviderID === 'gcp' && (
                <>
                  <br />
                  <span>
                    All addresses must be private IPv4 addresses, and belong to one of the following
                    ranges:
                    <ul>
          ...
          {showClusterPrivacy && (
            <>
              ...
              <GridItem>
                <p>
                  Clusters may be created initially with control plane API endpoint and application
                  routes being all public or all private. More options are available after the
                ...
                options={[
                  {
                    ...
                    label: (
                      <>
                        Public (recommended)
                        <div className="pf-c-radio__description">
                          Control plane API endpoint and application routes are accessible from the
                          internet.
                        </div>
                      </>
                    ),
