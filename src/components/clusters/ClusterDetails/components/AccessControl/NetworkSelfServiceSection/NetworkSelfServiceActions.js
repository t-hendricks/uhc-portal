import {
  GET_ROLES, ADD_GRANT, GET_GRANTS, CLEAR_ADD_GRANT_RESPONSE, DELETE_GRANT,
...
const getGrants = clusterID => dispatch => dispatch({
  type: GET_GRANTS,
...
const deleteGrant = (clusterID, grantId) => dispatch => dispatch({
  type: DELETE_GRANT,
