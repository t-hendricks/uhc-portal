...
export class InstallRHVIPI extends Component {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <AppPage title="Install OpenShift 4 | Red Hat OpenShift Cluster Manager | RHV Installer-Provisioned Infrastructure">
