  ...
  <Card>
    <div className="pf-c-content ocm-page">
      ...
      <div className="flex-container">
        <Link to="/install/rhv/installer-provisioned" className="aws-ipi-upi-infra-card infra-card pf-c-card">
        ...
        <Link to="/install/rhv/user-provisioned" className="aws-ipi-upi-infra-card infra-card pf-c-card">
          <CardBadge isHidden />
          <CardBody>
