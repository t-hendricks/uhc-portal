  ...
  <Card>
    <div className="pf-c-content ocm-page">
      ...
      <div className="flex-container">
        <Link to="/install/rhv/installer-provisioned" className="ipi-upi-infra-card infra-card pf-c-card">
        ...
        <Link to="/install/rhv/user-provisioned" className="ipi-upi-infra-card infra-card pf-c-card">
          <CardBadge isHidden />
          <CardBody>
            <UserIcon
