...
import canSubscribeOListCPSelector from '../common/EditSubscriptionSettingsDialog/CanSubscribeOCPListSelector';
...
const mapStateToProps = state => ({
  ...
  canSubscribeOCPList: canSubscribeOListCPSelector(state),
});
