...
import { Card, CardBody, Title, Text, TextContent, TextVariants } from '@patternfly/react-core';
    ...
    <CardBody>
      <TextContent>
        <Text component={TextVariants.p} className="pf-u-pl-lg">
          <input type="checkbox" className="pf-u-pr-md" /> I&apos;ve enabled ROSA service in my AWS
          account.
        </Text>
      </TextContent>
    </CardBody>
