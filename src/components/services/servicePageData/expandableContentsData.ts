export type ExpandalbeContents = {
  title: string;
  contents: string;
};

export const rosaBenefitsExpandableContents: ExpandalbeContents[] = [
  {
...
export const osdBenefitsExpandableContents: ExpandalbeContents[] = [
  {
...
export const osdFeaturesExpandableContents: ExpandalbeContents[] = [
  {
    title: 'Comprehensive application platform',
    contents:
