...
const clusterProperties = clusterProfiles['rosa-classic-public-advanced']['day1-profile'];
...
describe(
  ...
  () => {
    ...
    it('Step - Cluster roles and policies - advanced  options', () => {
      ...
      CreateRosaWizardPage.customOperatorPrefixInput()
        .type('{selectAll}')
        .type(`${clusterProperties.ClusterPrivacy.toLowerCase()}-${clusterName.substring(0, 18)}`);
      CreateRosaWizardPage.rosaNextButton().click();
    });
