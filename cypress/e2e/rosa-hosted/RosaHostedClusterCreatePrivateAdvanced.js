...
describe(
  'Rosa hosted cluster (hypershift) -create private advanced cluster with properties',
  { tags: ['day1', 'hcp', 'rosa', 'private', 'hosted', 'advanced'] },
  () => {
    before(() => {
    ...
    it(`Open Rosa wizard for private advanced cluster : ${clusterName}`, () => {
    ...
    it('Step - Review and create : Networking definitions', () => {
      ...
      if (clusterProperties.ClusterWideProxy.includes('Enabled')) {
        ...
        CreateRosaWizardPage.noProxyDomainsLabelValue().contains(
