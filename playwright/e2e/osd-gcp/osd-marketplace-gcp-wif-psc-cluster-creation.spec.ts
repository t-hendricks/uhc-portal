...
test.describe.serial(
  'OSD Marketplace GCP WIF PSC cluster creation tests (OCMUI-3888)',
  { tag: ['@smoke', '@osd'] },
  () => {
    ...
    test(`Launch OSD - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} cluster wizard`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} : Billing model and its definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} : Cluster Settings - Cloud provider definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} : Cluster Settings - Cluster details definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled}  : Cluster Settings - Default machinepool definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} : Networking configuration - cluster privacy definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled}  : VPC Settings definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled}  : Networking configuration - CIDR ranges definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled} : Cluster updates definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard - ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled}  : Review and create page definitions`, async ({
      page,
      createOSDWizardPage,
    }) => {
    ...
    test(`OSD wizard -  ${clusterProperties.Marketplace} ${clusterProperties.AuthenticationType} ${isPscEnabled}  : Cluster submission & overview definitions`, async ({
      createOSDWizardPage,
      clusterDetailsPage,
    }) => {
